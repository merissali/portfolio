    ...
    <main id="top">
      ...
      <div className="site-shell">
        ...
        <section id="about" className="about-section scroll-mt-8" aria-labelledby="about-title">
          <div className="about-intro"><p className="eyebrow">BUSINESS BRAIN. BUILDER’S INSTINCT.</p><h2 id="about-title">Comfortable with<br />the big picture.<br /><span className="serif-ish">And the messy middle.</span></h2><p>I studied Business and Computer Science at UBC, and I’ve kept a foot in both worlds ever since. My work has taken me from SQL analysis and front-end engineering to product discovery, growth experiments, and AI workflows.</p><p>Today, I own acquisition, subscription management, Flashcards, and internal support tooling at Rosetta Stone. I’m interested in bringing that mix of product thinking and hands-on building to new industries.</p><div className="toolkit"><span className="eyebrow">OFTEN IN MY TOOLKIT</span><div className="tags">{["SQL", "Amplitude", "GA4", "Figma", "Codex", "Gemini", "Jira"].map(tool=><span key={tool}>{tool}</span>)}</div></div></div>
        ...
        <section id="contact" className="contact-section scroll-mt-8" aria-labelledby="contact-title"><div><p className="eyebrow">NEXT CHAPTER, GOOD CONVERSATIONS</p><h2 id="contact-title">Something in mind?<br />Let’s talk<span aria-hidden="true" className="contact-star">✳</span></h2><p>I’m interested in product opportunities across industries.<br />I’d love to hear what you’re building.</p></div><a className="button button-dark" href="mailto:merissajli@gmail.com">merissajli@gmail.com <ArrowUpRight size={20}/></a></section>
